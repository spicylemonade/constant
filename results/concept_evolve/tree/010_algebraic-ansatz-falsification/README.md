# Concept: algebraic_ansatz_falsification

- Topic Context: try your absolute hardest and arrive at a new tighter bound

# Chvátal–Sankoff constant for a binary alphabet

## Description of constant

Let $\lambda\_{n,2}$ be the random variable assigning two uniformly random binary strings of length $ the length of their longest common subsequence.
Then \_{31a}$ is the (well-defined) limit \_{31a} := \lim\_{n \to \infty}\frac{\mathbb{E}[\lambda\_{n,2}]}{n}$.
...
| ----- | --------- | -------- |
| $ | Trivial | |
| /bin/bash.837623$ | [DP1995] | |
| /bin/bash.826280$ | [L2009] | Computer assisted |
...
| /bin/bash.773911$ | [D1994] | Computer assisted |
| /bin/bash.788071$ | [L2009] | Computer assisted |
| /bin/bash.792665992$ | [H2024] | Computer assisted |
...
- Domains: Algebraic Geometry, Chaotic Dynamical Systems
